...
function specialStats(draws){
 ...
 return Array.from({length:49},(_,i)=>{
  ...
  const score=count*8+recent20*5+recent10*5+Math.min(gap,30)*.15;
  return{n:num,count,gap,recent10,recent20,deviation,score}
