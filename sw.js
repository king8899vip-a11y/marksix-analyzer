const CACHE='marksix-analyzer-v1.9.0';
const SHELL=['./','./index.html','./styles.css?v=1.7.0','./app.js?v=1.9.0','./config.js?v=1.7.0','./data-service.js?v=1.7.0','./manifest.webmanifest'];
