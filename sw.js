const CACHE='marksix-analyzer-v2.0.2';
const SHELL=['./','./index.html','./styles.css?v=1.7.0','./app.js?v=2.0.2','./config.js?v=1.7.0','./data-service.js?v=1.7.0','./manifest.webmanifest'];
